...
This directory contains the runtime code for the **Brickwatch Analysis Agent**, powered by Amazon Bedrock AgentCore and Amazon Nova Pro.
...
```bash
aws logs tail /aws/bedrock-agentcore/runtimes/BrickwatchAnalysis-<runtime-id>-prod --follow
```
