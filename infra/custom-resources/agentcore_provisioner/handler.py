...
def _ensure_agentcore_resources(props: Dict[str, Any]) -> Dict[str, str]:
    agent_name = props.get('AgentName') or props.get('agentName') or 'Brickwatch'
    instruction = props.get('SystemPrompt') or 'You are Brickwatch, a cost optimization assistant.'
...
def handler(event, _context):
    ...
    physical_id = event.get('PhysicalResourceId') or 'BrickwatchAgentCore'
