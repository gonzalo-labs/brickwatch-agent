...
# Strands integration
try:
    from automation.strands_runner import RITAStrandRunner
...
async def analyze(request: Request) -> JSONResponse:
    ...
    try:
        ...
        return JSONResponse({"brand": "RITA", "analysis": data}, headers=_cors_headers())
    ...
    try:
        ...
        if workflow_endpoint and AGENTCORE_AVAILABLE:
            ...
            try:
                ...
                current_function = os.environ.get('AWS_LAMBDA_FUNCTION_NAME', 'RITAApiFn')
