...
```bash
aws logs tail /aws/lambda/RITAApiFn --follow
```
...
**Fix**: Deploy agents first, then API: `npx cdk deploy RITAAgentCore RITAWorkflowAgent RITAApi`
