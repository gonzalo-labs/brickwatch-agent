"""
RITAWorkflow Agent - Execution Agent for AWS Optimizations

This agent executes optimization recommendations using Amazon Nova Lite.
It receives recommendations from the RITA analysis agent and applies them
...
def _build_workflow_agent() -> Agent:
    ...
    system_prompt = (
        ...
        "Your job is to execute cost optimization recommendations provided by the RITA analysis agent.\n\n"
