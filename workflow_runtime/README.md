...
This directory contains the runtime code for the **Brickwatch Workflow Agent**, powered by Amazon Bedrock AgentCore and Amazon Nova Lite.
...
```bash
aws logs tail /aws/bedrock-agentcore/runtimes/BrickwatchWorkflow-<runtime-id>-prod --follow
```
